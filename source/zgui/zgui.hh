...
namespace zgui {
    ...
    using line_t = std::add_pointer_t<void(float x, float y, float x2, float y2, color color) noexcept>;
    using rect_t = std::add_pointer_t<void(float x, float y, float x2, float y2, color color) noexcept>;
    using filled_rect_t = std::add_pointer_t<void(float x, float y, float x2, float y2, color color) noexcept>;
    using text_t = std::add_pointer_t<void(float x, float y, color color, bool center, const char *text) noexcept>;
    ...
    namespace globals {
        ...
        static struct {
          ...
          color color_groupbox_header{26, 26, 26, 255};
        } global_colors;
